...
//  Calendar
//
//  Created by hzy on 16/11/1.
//  Copyright © 2016年 hzy. All rights reserved.
//

import Foundation

private let hzyformatter = DateFormatter()
...
extension Date {
    ...
    func stringWithDateFormat(_ dateFormat: String)->String {
        ...
        hzyformatter.dateFormat = dateFormat
        hzyformatter.calendar = self.calendar
        return hzyformatter.string(from: self)
    }

...
//  hzy
//
//  Created by hzy on 2018/3/14.
//  Copyright © 2018年 hzy. All rights reserved.
//

import UIKit

public protocol UIButtonCountDownable {}

extension UIButtonCountDownable where Self: UIButton {
    public func startWithTime(maxTime: Int, title: String, countDownUnit:String, bgColor: UIColor, runBgColor: UIColor) {
        var timeOut = maxTime

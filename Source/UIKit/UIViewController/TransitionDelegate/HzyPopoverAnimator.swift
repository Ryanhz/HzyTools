...
//  DS11WB
//
//  Created by hzy on 16/4/6.
//  Copyright © 2016年 hzy. All rights reserved.
//

import UIKit

enum HzyPopoverAnimatorStyle {
    case rightToLeft, bottomToTop, show
}

public class HzyPopoverAnimator: NSObject {
    ...
    var style: HzyPopoverAnimatorStyle = .bottomToTop
...
// MARK:- 弹出和消失动画代理的方法
extension HzyPopoverAnimator : UIViewControllerAnimatedTransitioning {
    /// 动画执行的时间

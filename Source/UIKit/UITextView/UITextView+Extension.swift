...
extension UITextView {
	...
	public func setPlaceHolder(_ placeHolderStr: String?) {
	...
	open override func willMove(toSuperview newSuperview: UIView?) {
        if newSuperview == nil {
            ...
            NotificationCenter.default.addObserver(self,selector: #selector(UITextView.didChange(_:)),name: UITextView.textDidChangeNotification,object: nil)
        }
	}
